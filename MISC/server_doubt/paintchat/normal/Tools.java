...
public class Tools extends LComponent implements ToolBox, ActionListener {
    ...
    private char[][] clValue = new char[][]{{'H', 'S', 'B', 'A'}, {'R', 'G', 'B', 'A'}};
    ...
    public void init(Container var1, Applet var2, Res var3, Res var4, Mi var5) {
        ...
        var1.add(this, 0);
        this.addC(this);
        if (var3.getP("tool_layer", true)) {
            this.L = new L(var5, this, this.res, var3);
                        ...
                        if (var4 < 14) {
                            ...
                            switch (var4) {
                                ...
                                case 17:
                                    ...
                                    var3.drawString((String) (String.valueOf(this.clValue[var9][var18]) + var12), 8, var8.height - 2);
                                    break;
                                case 18:
        ...
        if (this.primary == null) {
            try {
                ...
                if (this.primary != null) {
                    ...
                    this.primary.setClip(0, 0, var1.width, var1.height);
                }
    ...
    public void setSize(int var1, int var2) {
        if (this.applet == null) {
            ...
            synchronized (this) {
                ...
                this.getSize();
                float var10000 = (float) var1 / (float) this.W;
    ...
    public void showW(String var1) {
        ...
        if (this.cs != null) {
            for (var2 = 0; var2 < this.cs.length; ++var2) {
                if (this.cs[var2].getClass().getName().equals(var1)) {
                    if (!this.cs[var2].isVisible()) {
                        this.cs[var2].setVisible(true);
                    }
        ...
        if (this.ws != null) {
            for (var2 = 0; var2 < this.ws.length; ++var2) {
                if (this.ws[var2].getClass().getName().equals(var1)) {
                    if (!this.ws[var2].isVisible()) {
                        this.ws[var2].setVisible(true);
                    }
        ...
        try {
            SW var5 = (SW) Class.forName(var1).newInstance();
            if (var5 instanceof Window) {
                this.addC(var5);
                var5.mSetup(this, this.info, this.mi.user, this.mg, this.res, this.config);
            } else {
                LComponent var3 = (LComponent) var5;
                this.addC(var3);
            ...
            this.mi.alert(var4.getLocalizedMessage(), false);
        }
