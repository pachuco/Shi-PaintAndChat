...
public class TPalette extends LComponent {
    ...
    private static int[] clsDef = new int[]{0, 16777215, 11826549, 8947848, 16422550, 12621504, 16758527, 8421631, 2475977, 15197581, 15177261, 10079099, 16575714, 16375247};
    ...
    public void paint2(Graphics var1) {
        try {
            if (this.cls == null) {
                ...
                for (int var2 = 0; var2 < this.sizePalette; var2 += 2) {
                    this.cls[var2] = new Color(this.config.getP("color_" + (var2 + 2), var2 >= clsDef.length ? 16777215 : clsDef[var2]));
                    this.cls[var2 + 1] = new Color(this.config.getP("color_" + (var2 + 1), var2 >= clsDef.length ? 16777215 : clsDef[var2]));
                }
            }

            Dimension var11 = this.getSize();
            int var3 = Math.min((var11.height - 1) / 10, 64);
            int var4 = (int) ((float) var3 * 1.5F);
            int var5 = var3 <= 12 ? 0 : 2;
            int var6 = 0;
            int var10000 = this.cls.length;
            int var7 = 0;
            int var8 = 0;

            int var9;
            for (var9 = 0; var9 < this.cls.length; ++var9) {
                var1.setColor(this.cls[var6++]);
            ...
            var1.fillRect(var7 + var9, var8, var11.width - var9, var11.height - var8);
    ...
    private int pBar(Graphics var1, int var2, int var3, int var4) {
        ...
        if (clFont == null || clFont.getSize() != Math.max(var4 - 2, 1)) {
            clFont = new Font("sansserif", 0, Math.max(var4 - 2, 1));
        }
    ...
    public void pMouse(MouseEvent var1) {
        ...
        if (var3 <= var8 && var2 == 501) {
            ...
            var14 = var9 ? this.getRGB() : this.cls[var18].getRGB();
            if (var1.isShiftDown() && var18 < clsDef.length) {
                var14 = clsDef[var18];
            }

            this.tools.setRGB(var14);
        } else {
            boolean var13 = false;
            switch (var2) {
                case 501:
            ...
            if (var13) {
                if (this.iDrag == 0) {
                    ...
                    var14 = (int) ((float) (var3 - var8) / (float) (var5.width - var8) * 255.0F);
    ...
    public void setC(String var1) {
        try {
            ...
            while ((var1 = var2.readLine()) != null) {
                ...
                if (var3 < clsDef.length) {
                    clsDef[var3++] = this.cls[var3].getRGB() & 16777215;
                }
            }
